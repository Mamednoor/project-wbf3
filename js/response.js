...
!(function (a, b, c) {
  ...
  function i(a, b) {
    ...
    else for (var d in b) fb.call(b, d) && void 0 !== b[d] && (a[d] = b[d]);
    return a;
  }
  function j(a, b, d) {
    return null == a
    ...
    return null == a
      ...
      ? b && b > 0
        ...
        : ((a = "only all and (min--moz-device-pixel-ratio:" + a + ")"),
          Cb(a).matches ? !0 : !!Cb(a.replace("-moz-", "")).matches)
      : !1;
  }
  function m(a) {
  ...
  function n(a) {
    return (
      "data-" + (a ? a.replace(xb, "$1").replace(vb, "$1-$2").toLowerCase() : a)
    );
  }
  function o(a) {
    var b;
  ...
  function q(a, b) {
    ...
    return e.dataset && "undefined" != typeof DOMStringMap
      ? e.dataset
  ...
  function B(a, b) {
    var c = y(p(a), b);
    return (
      !!c && c.bottom >= 0 && c.top <= Eb() && c.right >= 0 && c.left <= Db()
    );
  }
  function C(a) {
    var b = {
        ...
        g.length &&
          ...
          Y(function () {
            ...
            f(d.target().$e, function (a, b) {
              (d[b] = yb(d).prepareData(a)),
                (!j || B(d[b].$e, e)) && d[b].updateDOM();
            }),
              d.dynamic && (d.custom || pb > c) && G(a, i),
              j &&
                (Z.on(h, b),
                d.$e.one(g, function () {
                  Z.off(h, b);
  ...
  var N,
    ...
    Ab = { allLoaded: zb("allLoaded"), crossover: zb("crossover") },
  ...
  return (
    ...
    (O = (function () {
      ...
      return {
        ...
        reset: function () {
          ...
          return (
            c !== this.i &&
              (Z.trigger(k).trigger(this.prop + k), (this.i = c || 0)),
            this
          );
        },
        configure: function (a) {
          ...
          if (
            ((this.uid = mb++),
            null == this.verge && (this.verge = l(pb, 500)),
            (this.fn = jb[r] || b("create @fn")),
            null == this.dynamic && (this.dynamic = "device" !== r.slice(0, 6)),
            (this.custom = kb[r]),
            (n = this.prefix ? h(d(e(this.prefix), c)) : ["min-" + r + "-"]),
            (o = 1 < n.length ? n.slice(1) : 0),
            (this.prefix = n[0]),
            (m = this.breakpoints),
            gb(m)
              ? (f(m, function (a) {
                ...
                q && m.sort(j),
                m.length || b("create @breakpoints"))
              : (m = hb[r] || hb[r.split("-").pop()] || b("create @prop")),
            (this.breakpoints = q
              ? h(m, function (a) {
                  return pb >= a;
                })
        ...
        prepareData: function (b) {
          if (
            ((this.$e = a(b)),
            (this.mode = C(b)),
            (this.values = E(this.$e, this.keys)),
            this.aka)
          )
            for (var c = this.aka.length; c--; )
              this.values = i(this.values, E(this.$e, this.aka[c]));
    ...
    (jb.width = P),
    (jb.height = Q),
    (jb["device-width"] = ib.band),
    (jb["device-height"] = ib.wave),
    (jb["device-pixel-ratio"] = l),
    (N = {
      deviceMin: function () {
        return qb;
      },
