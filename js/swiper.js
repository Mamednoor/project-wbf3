  ...
  function r() {
    if ((H && C.swipeReset(), !b.onlyExternal && C.isTouched)) {
      ...
      if (((C.isMoved = !1), b.freeMode)) {
        if (b.freeModeFluid) {
          var g,
            h = 1e3 * b.momentumRatio,
            i = C.velocity * h,
            j = C.positions.current + i,
            k = !1,
            l = 20 * Math.abs(C.velocity) * b.momentumBounceRatio;
          -f > j &&
            (b.momentumBounce && C.support.transitions
              ? (-l > j + f && (j = -f - l), (g = -f), (k = !0), ($ = !0))
              : (j = -f)),
            j > 0 &&
              (b.momentumBounce && C.support.transitions
                ? (j > l && (j = l), (g = 0), (k = !0), ($ = !0))
                : (j = 0)),
            0 !== C.velocity &&
              (h = Math.abs((j - C.positions.current) / C.velocity)),
      ...
      (G = 0 > a ? "toNext" : "toPrev"),
        "toNext" === G &&
          300 >= d &&
          (30 > c || !b.shortSwipes ? C.swipeReset() : C.swipeNext(!0)),
        "toPrev" === G &&
          300 >= d &&
          (30 > c || !b.shortSwipes ? C.swipeReset() : C.swipePrev(!0));
      var m = 0;
      if ("auto" === b.slidesPerView) {
        for (
          var n, o = Math.abs(C.getWrapperTranslate()), p = 0, q = 0;
          q < C.slides.length;
          q++
        )
          if (
            ((n = M
              ? C.slides[q].getWidth(!0, b.roundLengths)
              : C.slides[q].getHeight(!0, b.roundLengths)),
            (p += n),
            p > o)
          ) {
            m = n;
      ...
      "toNext" === G &&
        d > 300 &&
        (c >= m * b.longSwipesRatio ? C.swipeNext(!0) : C.swipeReset()),
        "toPrev" === G &&
          d > 300 &&
          (c >= m * b.longSwipesRatio ? C.swipePrev(!0) : C.swipeReset()),
        b.onTouchEnd && C.fireCallback(b.onTouchEnd, C),
      ...
      this.support.transforms && this.params.useCSS3Transforms
        ? ((d = window.getComputedStyle(f, null)),
          window.WebKitCSSMatrix
            ? (e = new WebKitCSSMatrix(d.webkitTransform))
            : ((e =
                d.MozTransform ||
                d.OTransform ||
                d.MsTransform ||
