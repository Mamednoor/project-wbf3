    ...
    (function (e) {
      ...
      e.mobile.zoom = e.extend(
        {},
        {
          ...
          disable: function (n) {
            !s &&
              !e.mobile.zoom.locked &&
              (t.attr("content", r),
              (e.mobile.zoom.enabled = !1),
              (e.mobile.zoom.locked = n || !1));
          },
          enable: function (n) {
            !s &&
              (!e.mobile.zoom.locked || n === !0) &&
              (t.attr("content", i),
              (e.mobile.zoom.enabled = !0),
              (e.mobile.zoom.locked = !1));
          },
          restore: function () {
    ...
    (function (e, t) {
      ...
      if (
        !(
          ...
          /OS [1-5]_[0-9_]* like Mac OS X/i.test(n) &&
      ...
      (r = e.mobile.zoom),
        e.mobile.document.on("mobileinit", function () {
          e.mobile.iosorientationfixEnabled &&
            e.mobile.window
              .bind("orientationchange.iosorientationfix", r.enable)
              .bind("devicemotion.iosorientationfix", f);
        });
    })(e, this);
});
